                              ...
                              <div style={{ flex: 1 }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                  <span style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f97316' }}>
                                    {/* GENIUS FIX: Use price directly, not priceFormatted (which already has ₹) */}
                                    ₹{typeof item.price === 'number' ? item.price : (item.priceFormatted || '0').replace('₹', '')}
                                  </span>
                                  {item.originalPrice && (
                                    <span style={{ fontSize: '0.85rem', color: '#9ca3af', textDecoration: 'line-through' }}>
                                      ₹{typeof item.originalPrice === 'number' ? item.originalPrice : (item.originalPriceFormatted || '0').replace('₹', '')}
                                    </span>
                                  )}
                                </div>
                              </div>
